...
import com.lsj.test.securitytest.bean.UserBeanExample.Criteria;
import com.lsj.test.securitytest.bean.UserBeanExample.Criterion;
...
public class UserBeanSqlProvider {
    ...
    protected void applyWhere(UserBeanExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
